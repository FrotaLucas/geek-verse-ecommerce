...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeekVerse.Shared.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.CartItem", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("GeekVerse.Shared.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeekVerse.Shared.Address", b =>
                {
                    b.HasOne("GeekVerse.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("GeekVerse.Shared.Address", "UserId")
            ...
            modelBuilder.Entity("GeekVerse.Shared.OrderItem", b =>
                {
                    b.HasOne("GeekVerse.Shared.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GeekVerse.Shared.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GeekVerse.Shared.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("GeekVerse.Shared.Product", b =>
                {
                    b.HasOne("GeekVerse.Shared.Category", "Category")
                        .WithMany()
